    ...
    return (
        <div name='hero' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className='absolute w-full h-full mx-auto flex flex-col items-center justify-center'>
                ...
                <h1 name='title' className='z-20 title-main text-2xl text-center sm:text-5xl text-shadow shadow-black font-bold text-white'>Skyline Computer Science Club</h1>
                ...
                <Link to='about' smooth={true} duration={1200} className='z-20 mt-4 relative group w-[14vw] border-2 text-white text-lg title-main outline-white overflow-hidden'>
                    <IoMdArrowRoundDown className='absolute w-full h-full group-hover:translate-y-0 -translate-y-[100%] duration-300 pointer-events-none bg-gradient-to-t from-[#16a34ac0] to-[#ffffff3b]'/>
