...
const SECTION_TYPED_KEYWORDS = ["Design", "Libraries", "Development Suites", "Frameworks", "Linux Distributions", "Databases", "Languages"]
    ...
    return (
        <div className="w-full h-full mt-60 text-gray-300 overflow-hidden">
            ...
            <h1 className="title-main mx-auto text-2xl text-center sm:text-4xl font-extrabold text-[#e7e9ef]"> 
                <span className="text-shadow shadow-gray-700">Join us in Exploring</span> <Typed strings={SECTION_TYPED_KEYWORDS} typeSpeed={50} backSpeed={75} backDelay={5000} loop className="bg-gradient-to-t from-yellow-300 to-green-400 bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(50,255,100,0.5)]"></Typed>
            </h1>
