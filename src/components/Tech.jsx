...
import { SiRobloxstudio, SiJavascript, SiHtml5, SiCss3, SiTypescript, SiPython, SiLua, SiRust, SiCplusplus, SiNodedotjs } from 'react-icons/si'
...
export default function Tech() {
    ...
    return (
        <div name='tech' className='w-full h-full mt-60 text-gray-300 overflow-hidden'>
            ...
            <motion.img width={'6.5%'} src={kittyAstro} className='mx-auto my-10 hover:!scale-105 transition duration-300 ease-out' initial={{transform: 'translateY(-10%)'}}  animate={{transform: `translateY(10%)`}} transition={{repeat: Infinity, repeatType: 'mirror', type: 'tween', ease: 'linear', duration: 2 }}/>
            ...
            <div className='relative'>
                ...
                <div className='flex my-10 h-[18vh] bg-repeat-x bg-bottom' style={{backgroundImage: `url(${conveyorFront})`}}>
                    <motion.div className='flex h-full' initial={{transform: 'translateX(-100%)'}} animate={{transform: `translateX(100vw)`}} transition={{repeat: Infinity, type: 'tween', ease: 'linear', duration: 34 }}>
