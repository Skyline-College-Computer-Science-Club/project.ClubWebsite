...
const TECHNOLOGIES: Record<string, JSX.Element> = {
  Rust: (
    <SiRust
  ...
  return (
    <div className='w-full h-full mt-60 text-gray-300 overflow-hidden'>
      ...
      <h1 className='title-main mx-auto text-2xl text-center sm:text-4xl font-extrabold text-[#e7e9ef]'>
        ...
        <Typed
          strings={['Technologies', 'Libraries', 'Frameworks', 'Software']}
          typeSpeed={50}
          backSpeed={75}
          backDelay={5000}
          loop
            ...
            {Object.entries(TECHNOLOGIES).map(([technology_name]) => {
              return (
                <div
                  ...
                  key={technology_name}
                  className='flex h-full mx-5 hover:scale-110 duration-300'
                >
