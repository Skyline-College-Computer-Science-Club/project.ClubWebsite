            ...
            <div className="flex flex-col w-screen h-screen justify-center items-center overflow-hidden">
                ...
                <div className="flex flex-col my-1 gap-3 items-center">
                    <div className="bg-[#ffd035a4] rounded-2xl p-2 px-6 font-semibold transition-all hover:scale-105 text-center w-full">
                        <Typed strings={[participant.name]} typeSpeed={75} backSpeed={75} backDelay={99999} loop className="bg-gradient-to-t from-white to-white bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(255,255,255,1)] font-bold"></Typed>
                    </div>
                    <div className="bg-[#cc00ff75] rounded-2xl p-2 px-6 font-semibold transition-all hover:scale-105 text-center w-full">
                        <Typed strings={[participant.email]} typeSpeed={75} backSpeed={75} backDelay={99999} loop className="bg-gradient-to-t from-white to-white bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(255,255,255,1)] font-bold"></Typed>
                    </div>
                    <div className="bg-[#0f6186] rounded-2xl p-2 px-6 font-semibold transition-all hover:scale-105 text-center w-full">
                        From <Typed strings={[participant.college]} typeSpeed={75} backSpeed={75} backDelay={99999} loop className="text-white drop-shadow-[0_0_8px_rgba(255,255,255,1)] font-bold"></Typed>
                    </div>
                    ...
                    <div className="flex bg-[#1bff2675] rounded-2xl w-60 h-10 font-semibold transition-all hover:scale-105 text-center">
                        ...
                        <span className="mx-auto my-auto text-center cursor-grab" onMouseDown={() => {queryDatabase(participant.email)}}>
